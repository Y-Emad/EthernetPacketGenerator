...
GENERATOR_SRC = main.cpp EthernetPacket.cpp
...
run: all
	@if exist ethernet_packet.bin del ethernet_packet.bin  # Windows delete command
	./$(GENERATOR)
	./$(PARSER)
...
clean:
	...
	if exist ethernet_packet.bin del ethernet_packet.bin
